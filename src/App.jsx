...
const App = () => {
  const desserts = [
    { id: 1, name: "Waffle with Berries", price: 6.5, img: "waffle-thumbnail.jpg" },
    { id: 2, name: "Vanilla Bean Crème Brûlée", price: 7, img: "creme.jpg" },
        ...
        <div style={styles.dessertList}>
          {desserts.map((dessert) => (
            <div key={dessert.id} style={styles.card}>
              <img src={dessert.img} alt={dessert.name} style={styles.image} />
